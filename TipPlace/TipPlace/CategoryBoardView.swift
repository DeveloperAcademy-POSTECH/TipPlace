        ...
        NavigationView {
            VStack {
                ...
                HStack {
                    ...
                    Text("정렬")
                    Button{print("sorting")} label:{
                        ZStack{Image(systemName: "arrow.up.arrow.down")}}
                }
                BoardList()
            }
            .navigationTitle(categoryEnum.korean)
            .toolbar{ToolbarItem(placement:.navigationBarTrailing){
                NavigationLink{Text("Dophi's writing")
                            } label: {
